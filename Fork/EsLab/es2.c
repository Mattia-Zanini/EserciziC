...
#include <unistd.h>
#include <sys/wait.h>
//da rifinire ma non capisco nulla di c (little crying face)
//grazie mille per anydesk ma non capisco bene il funzionamento della fork con altre fork all'interno
int main()
{
    int f1, f2, g, h, padre;
    padre = getpid();
